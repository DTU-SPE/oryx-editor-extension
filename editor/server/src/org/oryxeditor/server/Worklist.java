...
public class Worklist extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out
				.println("<script type=\"text/javascript\" src=\"lib/ext-2.1.0/adapter/ext/ext-base.js\"></script>");
		out
				.println("<script type=\"text/javascript\" src=\"lib/ext-2.1.0/adapter/yui/yui-utilities.js\"></script>");
		out
				.println("<script type=\"text/javascript\" src=\"lib/ext-2.1.0/adapter/yui/ext-yui-adapter.js\"></script>");
		out
				.println("<script type=\"text/javascript\" src=\"lib/ext-2.1.0/ext-all-debug.js\"></script>");
		...
		out
				.println("<style type=\"text/css\">\n"
						+ "@import url(\"lib/ext-2.1.0/resources/css/ext-all.css\");\n"
						+ "@import url(\"lib/ext-2.1.0/resources/css/xtheme-gray.css\");\n"
						+ "</style>\n");
		out.println("</head>");
